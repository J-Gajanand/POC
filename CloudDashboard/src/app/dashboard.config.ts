...
/**
 * Backend timestamps are UTC but serialized without a 'Z' suffix (SQL Server
 * round-trips DateTime as Unspecified kind). Parse them explicitly as UTC so all
 * client-side time math (online window, throughput, ordering) is correct.
 */
